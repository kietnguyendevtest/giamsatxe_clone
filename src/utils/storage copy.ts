...
const storage = {
   ...
   setCurrentPageLv2: (current_page: string) => {
      return localStorage.setItem(config.KEY_STORAGE_CURRENT_PAGE_LV2, CryptoJS.Rabbit.encrypt(current_page, config.SECRET_ENCRYPTION).toString());
   },
